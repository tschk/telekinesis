...
TUI, CLI, and GUI forward rotary host events (`RetryReason`, `ProcessStdin`, `RequestPermissions`, `PatchHunk`, `Recovery`, and spill/failure notices) the same way as tool execution and approvals.
